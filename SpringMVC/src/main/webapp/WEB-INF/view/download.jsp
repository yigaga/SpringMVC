    ...
    <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
            <ul class="nav nav-sidebar">
                ...
                <li class="active"><a href="http://localhost:8080/SpringMVC/disk/download">云盘管理</a></li>
                <li><a href="#">回收站</a></li>
                <li><a href="#">个人中心</a></li>
            </ul>
        </div>
            ...
            <div class="table-responsive">
                <table class="table table-striped">
                    ...
                    <tr>
                        ...
                        <td><%=file%></td>
                        <td><%=fType%></td>
                        <td><a href="load?filename=<%=file%>" download="<%=file%>">下载</a></td>
                        <td><a href="delete?filename=<%=file%>">删除</a></td>
                    </tr>
                    <%
                            }
                        }
