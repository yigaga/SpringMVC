...
<div class="container">
    ...
    <form class="form-signin" method="post" action="http://localhost:8080/SpringMVC/user/signup">
        ...
        <p> </p>
        <p> </p>
        <a class="btn btn-lg btn-success btn-block" href="http://localhost:8080/SpringMVC/user/login" role="button" >已有账号?马上登录</a>
    </form>
