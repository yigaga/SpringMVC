    ...
    <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
            <ul class="nav nav-sidebar">
                <li><a href="http://localhost:8080/SpringMVC/disk/show">主页 <span class="sr-only">(current)</span></a></li>
                <li class="active"><a href="http://localhost:8080/SpringMVC/disk/share">分享</a></li>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            ...
            <form action="http://localhost:8080/SpringMVC/disk/shared" method="POST" enctype="multipart/form-data" content="charset=UTF-8">
     			<h2 class="form-signin-heading">请输入你想要分享的用户名和文件</h2>
        		<input name="username2" id="User Name" class="form-control" placeholder="username" required autofocus>
        		<input id="input" name="file" type="file" class="file" multiple
                       data-show-upload="false" data-show-caption="true" data-msg-placeholder="Select {files} for upload...">
				<button class="btn btn-success" type="submit">确认分享</button>
